...
public class RTGSTransferStrategyImplTest {
	...
	public void testProcessPayment() {
		...
		MoneyTransferResponse response = mockRTGSTransferStrategyImpl.processPayment(request);
	...
	public void testProcessPaymentWithExceptionWhilePersisting() {
		...
		Exception response = assertThrows(DataAccessException.class,
				() -> mockRTGSTransferStrategyImpl.processPayment(request));
		assertNotNull(response);
	...
	public void testGetTransferMode() {
		assertEquals(TransferMode.RTGS, mockRTGSTransferStrategyImpl.getTransferMode());
	}
